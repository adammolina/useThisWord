...
myForm.addEventListener("submit", (e) => {
  ...
  function theBadWord() {
    ...
    var badWordArr = ["fuck", "shit", "bitch", "cunt", "ass", "dick", "dumbass"
      ,"dickhead", "pussy", "wanker", "fucker", "motherfucker", "dogshit", "asshole", "balls", "bullshit", "tits", "tit", "prick", "twat", "punani", "minge", "cock", "bastard", "nig", "nigga", "nigger", "spic", "fag", "faggot", "horseshit"
    ];
